...
class CompanyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'telephone_contact_1' => ['required','string','max:255', new TelephoneContactRule],
            'telephone_contact_2' => ['required','string','max:255', new TelephoneContactRule],
            ...
            'zipcode' => ['required','string', 'max:255', new ZipcodeFormatRule],
            'country' => 'required|string|max:255',
            'currency_code' => 'required|string|max:255',

            'registration_number' => ['required','string','max:255', new UniqueBusinessRegistrationRule],
