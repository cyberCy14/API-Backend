...
class getLocationDataHelper{
  ...
  protected static string $phLocationsPath = 'philippine_provinces_cities_municipalities_and_barangays_2019v2.json';
  ...
  public static function getRegions():array{
    ...
    $data = self::loadData();
    return Collection::make($data['region_code'])->mapWithKeys(fn ($region, $code) => [$code => $region['region_name']])
        ->all();
