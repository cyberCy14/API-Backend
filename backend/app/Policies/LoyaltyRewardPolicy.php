...
class LoyaltyRewardPolicy
{
     ...
     */
    public function forceDelete(User $user, LoyaltyReward $reward): bool
    {
     ...
     */
    public function restore(User $user, LoyaltyReward $reward): bool
    {
     ...
     */
    public function replicate(User $user, LoyaltyReward $reward): bool
    {
